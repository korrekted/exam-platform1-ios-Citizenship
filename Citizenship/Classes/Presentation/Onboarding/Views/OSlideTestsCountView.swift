...
private extension OSlideTestsCountView {
    func makeConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            imageView.heightAnchor.constraint(equalToConstant: ScreenSize.isIphoneXFamily ? 270.scale : 219.scale),
            imageView.widthAnchor.constraint(equalToConstant: 240.scale),
...
private extension OSlideTestsCountView {
    ...
    func makeSlider() -> UISlider {
        ...
        view.minimumValue = 1
        view.maximumValue = 7
        view.minimumTrackTintColor = UIColor(integralRed: 145, green: 200, blue: 195)
