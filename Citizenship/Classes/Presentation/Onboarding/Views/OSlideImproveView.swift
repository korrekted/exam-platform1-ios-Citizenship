...
private extension OSlideImproveView {
    func makeConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            tag1.topAnchor.constraint(equalTo: topAnchor, constant: ScreenSize.isIphoneXFamily ? 356.scale : 276.scale)
        ])
        ...
        NSLayoutConstraint.activate([
            ...
            tag2.topAnchor.constraint(equalTo: topAnchor, constant: ScreenSize.isIphoneXFamily ? 284.scale : 204.scale)
        ])
        ...
        NSLayoutConstraint.activate([
            ...
            tag3.topAnchor.constraint(equalTo: topAnchor, constant: ScreenSize.isIphoneXFamily ? 450.scale : 370.scale)
        ])
        ...
        NSLayoutConstraint.activate([
            ...
            tag4.topAnchor.constraint(equalTo: topAnchor, constant: ScreenSize.isIphoneXFamily ? 412.scale : 332.scale)
        ])
